...
export const genericNodeSchema = {
  ...
  $defs: genericNodeDefinitions,
} as const;

export const pipelineSchema = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: PIPELINE_SCHEMA_ID,
  type: "object",
  properties: {},
  additionalProperties: {
    anyOf: [...standardLibrarySchema, { $ref: ref("GenericNode") }],
  },
  $defs: genericNodeDefinitions,
} as const;
